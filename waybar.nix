...
programs.waybar = {
	...
	settings = {
        mainBar = {
            height = 20;
            layer = "top";
            modules-left = ["custom/launcher" "cpu" "memory" "disk" "custom/weather" "hyprland/workspaces"];
            modules-center = ["clock"];
            modules-right = ["network" "pulseaudio" "backlight" "battery" "tray" "hyprland/language" "custom/power-menu"];
